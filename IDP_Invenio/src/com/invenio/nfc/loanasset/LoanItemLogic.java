...
public class LoanItemLogic {
	static HashMap<Integer, String> loanMap = new HashMap<Integer, String>();;
	...
	public static void remove(String item){
		for (Entry<Integer, String> e : loanMap.entrySet()) {
	...
	public static void loanSuccessDialog(){
		...
		// Setting Dialog Title
		//alertDialog2.setTitle("Update Loanee Details");

		// add message
		alertDialog2.setMessage("Place phone against tag to start writing");
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(
						...
						try {
							// clearListItems();
							ourClass = Class
									.forName("com.invenio.nfc.loanasset.ScanLoanWriteActivity");
	...
	public static void createLoanItemAlertDialog(String title,
			final String cancelAction, String record) {
