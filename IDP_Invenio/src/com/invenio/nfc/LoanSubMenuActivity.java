...
public class LoanSubMenuActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		try {
			...
			setListAdapter(new ArrayAdapter<String>(LoanSubMenuActivity.this, R.layout.custom_listview, classes));
...
protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try{
			Class ourClass = Class.forName("com.invenio.nfc." + clickedOption);
			Intent ourIntent = new Intent(LoanSubMenuActivity.this, ourClass);
