...
public class ScanRegisterWriteActivity extends Activity {
	...
	private void collateTagInfo(){
		...
		try {
			if(mytag==null){
				...
				write(TagLogic.formattedTagInfo, mytag);
				  ...
				  public void run() {
				    //Do something after 100ms
					  AlertDialog.Builder alertDialog2 = new AlertDialog.Builder(
								ScanRegisterWriteActivity.this);
										...
										new DialogInterface.OnClickListener() {
											...
											public void onClick(
												...
												try {
													...
													Intent ourIntent = new Intent(ScanRegisterWriteActivity.this, ourClass);
													ScanRegisterWriteActivity.this
		...
		case R.id.menu_main:
			...
			try {
				...
				Class ourClass = Class
						.forName("com.invenio.nfc.MainMenuActivity");
				Intent ourIntent = new Intent(ScanRegisterWriteActivity.this,
						ourClass);
				startActivity(ourIntent);
			} catch (ClassNotFoundException e) {
				e.printStackTrace();
